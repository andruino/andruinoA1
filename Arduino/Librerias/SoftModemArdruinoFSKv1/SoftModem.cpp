...
#define F_CPU	(16000000)	        // Andruino. 22/10/2012. Definición de frec. de Arduino UNO
...
////Para usar el pin6 como PWM
//	ADCSRB |= _BV(ACME); //Para usar el pin6 como PWM
//	ADCSRA &= ~(_BV(ADEN)); //Para usar el pin6 como PWM
//Fin de Para usar el pin6 como PWM
...
void SoftModem::demodulate(void)
{
	...
	//Serial.println("Valor de la diff: ");
...
ISR(ANALOG_COMP_vect)
{
	...
	//Serial.println("Interrupción de comparación");
	act->demodulate();
}
